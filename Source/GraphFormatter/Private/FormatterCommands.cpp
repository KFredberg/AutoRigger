...
void FFormatterCommands::RegisterCommands()
{
	...
	UI_COMMAND(OpenPanel, "Open Panel", "Auto format graph using Layered Graph Drawing algorithm", EUserInterfaceActionType::Button, FInputChord(EKeys::A, false, false, true, false));
